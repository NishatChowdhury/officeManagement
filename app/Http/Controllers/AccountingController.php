...
//            $account = COA::query()->findOrFail($request->get('account'))->name;
        ...
        return view('admin.account-management.accounting.ledger',compact('coa','acc'));
    }
    ...
    public function trialBalance(Request $request)
    {
        ...
        return view('admin.account-management.accounting.trial-balance',compact('accounts','start','end'));
    }
    ...
    public function profitNLoss(Request $request)
    {
        ...
        return view('admin.account-management.accounting.profit-n-loss',compact('incomes','expenses','start','end'));
    }
    ...
    public function balanceSheet(Request $request)
    {
        ...
        return view('admin.account-management.accounting.balance-sheet',compact('start','end','assets','liabilities','equities'));
    }
