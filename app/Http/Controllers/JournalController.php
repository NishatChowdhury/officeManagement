...
class JournalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //dd($journals);
        return view('admin.account-management.journal.index',compact('journals','coa'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.account-management.journal.create',compact('coa','journalNo'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.account-management.journal.show',compact('journal'));
    }
    ...
    {
        //return view('admin.account-management.journals.edit', compact('journal'));
    }
    ...
    public function classic(Request $request)
    {
        ...
        return view('admin.account-management.journal.classic',compact('journals','start','end'));
    }
