...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['url'=>'admin/ledger','method'=>'get']) }}
                <div class="row">
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($accounts as $account)
                                        <tr>
                                            <td><a class="btn btn-outline-primary btn-sm text-bold" href="{{ url('admin/journals',$account->journal->id) }}">{{ $account->journal->journal_no }}</a></td>
