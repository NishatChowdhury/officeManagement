...
@section('title','Settings |Edit Employee')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            {{ Form::model($employee,['route'=>['employee.update',$employee->id],'method'=>'patch', 'class'=>'form-horizontal','enctype'=>'multipart/form-data']) }}
                            <div class="card-body">
                                <ul>
                                    @php $i=0; @endphp
                                    @foreach($errors->all() as $error)
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="basic_info">
                                        @include('admin.employee-management.edit-basic-info')
                                    </div>
                                    <div class="tab-pane" id="address">
                                        @include('admin.employee-management.edit-address')
                                    </div>
                                    <div class="tab-pane" id="official">
                                        @include('admin.employee-management.edit-official')
                                    </div>
                                    <div class="tab-pane" id="academic">
                                        @include('admin.employee-management.edit-academic')
                                    </div>
                                    <div class="tab-pane" id="status">
                                        @include('admin.employee-management.edit-status')
                                    </div>
                                    <div class="tab-pane" id="experience">
                                        @include('admin.employee-management.edit-experience')
                                    </div>
                                    <div class="tab-pane" id="training">
                                        @include('admin.employee-management.edit-training')
                                    </div>
                                    <div class="tab-pane" id="weeklyOff">
                                        @include('admin.employee-management.edit-weekly-off')
                                    </div>
                                </div>
                                <!-- /.tab-content -->
                            </div><!-- /.card-body -->
