<div class="row">
    <div class="col">
        <div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}">
            ...
            control-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('department_id', $departments, null, ['id' =>
                'department_id', 'class' =>
    ...
    <div class="col">
        <div class="form-group{{ $errors->has('designation_id') ? ' has-error' : '' }}">
            ...
            control-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('designation_id', $designations, null, ['id' =>
    ...
    <div class="col">
        <div class="form-group">
            ...
            {{ Form::date('joining_date',null,['class'=>'form-control ','placeholder'=>'Enter Date:']) }}
        </div>
    </div>
...
<div class="row">
    <div class="col">
        <div class="form-group{{ $errors->has('calender_code_id') ? ' has-error' : '' }}">
            ...
            control-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('calender_code_id', $calendars, null, ['id' =>
    ...
    <div class="col">
        <div class="form-group{{ $errors->has('shift_id') ? ' has-error' : '' }}">
            ...
            control-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('shift_id', $shifts, null, ['id' =>
                'shift_id', 'class' =>
                'form-control', 'required' => 'required']) !!}
    ...
    <div class="col">
        <div class="form-group">
            ...
            {{ Form::number('gross',null,['class'=>'form-control ','placeholder'=>'Enter Gross Here:']) }}
        </div>
    </div>
</div>
